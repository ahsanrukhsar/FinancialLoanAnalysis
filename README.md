...
Objective
The goal of this project is to empower students to explore and analyze loan-related financial data, derive actionable insights, and visualize key metrics using an interactive dashboard. The dashboard should help stakeholders understand loan performance, applicant demographics, repayment trends, and risk indicators

Business Scenario
A financial institution provides various types of loans to customers. The management wants to understand trends and patterns in loan approvals, repayments, defaults, and customer profiles. The institution has provided historical data and requires a dashboard that can answer key business questions and support decision-making processes.
